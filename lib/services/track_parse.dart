...
// Düz indeks adımıyla (her N. noktayı al) sadeleştirmek uzun/yoğun GPX'lerde
// köşeleri siliyordu (dönüşler örneklenen indeksler arasına düşüyordu).
// Nokta başına ~60-80 bayt — 5000 nokta bile tek iz için ~350 KB, bellek
// açısından önemsiz; asıl maliyet çizim (bkz. _TrackLinesLayer), o da ayrı
// ve daha düşük bir tavanla sınırlı.
const trackDisplayMaxPoints = 5000;
